<?php
 /** How do I read the Cmsimple's environment file? Help
 * defines admin mode
...
include_once('./languages/'. $plugin_cf['xh_emoji']['popupWindow_lang'] . '.php');

$xh_emoji_path = "../../plugins/xh_emoji/";
$xh_emoji_path_for_tmc = $plugin_cf['xh_emoji']['emoji_icon_path'];
?>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title><? echo $plugin_tx['xh_emoji']['popupmenu_title']; ?></title>
	<script language="javascript" type="text/javascript" src="../tinymce4/tinymce/tiny_mce_popup.js"></script>
	<script language="javascript" type="text/javascript" src="../tinymce4/tinymce/utils/form_utils.js"></script>
	<link rel='stylesheet' id='wp_emoji-css'  href="./css/style.min.css" type='text/css' media='all' />
	<base target="_self" />

	<script language="javascript" type="text/javascript" src="../tinymce4/tinymce/plugins/xh_emoji/InsertEmoji.js"></script>
</head>
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
  ...
  <label for="tab1" title="<? echo $plugin_tx['xh_emoji']['popupmenu_people']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/smiley.png" alt="" /></label>
  <input id="tab2" type="radio" name="tabs">
  <label for="tab2" title="<? echo $plugin_tx['xh_emoji']['popupmenu_nature_and_animals']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/flower.png" alt="" /></label>
  <input id="tab3" type="radio" name="tabs">
  <label for="tab3" title="<? echo $plugin_tx['xh_emoji']['popupmenu_food_and_drink']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/apple.png" alt="" /></label>
  <input id="tab4" type="radio" name="tabs">
  <label for="tab4" title="<? echo $plugin_tx['xh_emoji']['popupmenu_celebration']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/bow.png" alt="" /></label>
  <input id="tab5" type="radio" name="tabs">
  <label for="tab5" title="<? echo $plugin_tx['xh_emoji']['popupmenu_activity']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/swim.png" alt="" /></label>
    <input id="tab6" type="radio" name="tabs">
    <label for="tab6" title="<? echo $plugin_tx['xh_emoji']['popupmenu_travel_and_places']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/car.png" alt="" /></label>
  <input id="tab7" type="radio" name="tabs">
  <label for="tab7" title="<? echo $plugin_tx['xh_emoji']['popupmenu_objects_and_symbols']; ?>"><img src="<?php echo $xh_emoji_path; ?>img/clock.png" alt="" /></label>
  <hr><br />
    ...
    <span class="size-box">
		<label for="icon-size"><? echo $plugin_tx['xh_emoji']['size_size']; ?></label></th>
            ...
            <em><? echo $plugin_tx['xh_emoji']['size_info']; ?></em><br/>
	</span>
...
<div style="float: right; margin:5px 35px 0 0;">
    ...
    <script type="text/javascript">
        //<![CDATA[
        var wpemojionedomain = '<?php echo $xh_emoji_path_for_tmc; ?>';
        function saveSize() {
