{
  ...
  plugins: [
    ...
    "save searchreplace table textcolor visualblocks visualchars wordcount compat3x xh_emoji"
  ],

  toolbar1: "save | fullscreen code formatselect fontselect fontsizeselect styleselect xh_emoji",
